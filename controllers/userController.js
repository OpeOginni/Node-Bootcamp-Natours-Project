...
}); // To recieve files like Pictures ETC
...
exports.resizeUserPhoto = catchAsync(async (req, res, next) => {
  ...
  req.file.filename = `user-${req.user.id}-${Date.now()}.jpeg`; // Since Sharp will always make the file a JPEG
...
exports.updateMe = catchAsync(async (req, res, next) => {
  ...
  // 2) Filtered out unwanted field names that are not alloed to be updated
