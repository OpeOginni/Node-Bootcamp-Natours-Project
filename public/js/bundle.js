      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Logged in successfully!'); // an alert is given when user is succesfully logged in
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', _context.t0.response.data.message); // Advice to use Alert for the Project
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfuly!")); // an alert is given when user's data is succesfully updated in
          }
          _context.next = 11;
          break;
        case 8:
